...
export class SlackEventHandlerSpec implements ISpec<SlackEventHandler> {
    ...
    private createMessage(
        ...
        return this.createEvent<ISlackEventMessagePosted>(
            partialEvent,
    ...
    private createReaction(
        ...
        const partialEvent = {
            reaction: emoji as SlackEmoji,
            user: this.testConstants.userId,
        };
        return this.createEvent<ISlackEventReactionAdded>(
            partialEvent,
